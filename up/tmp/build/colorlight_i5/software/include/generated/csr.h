...
#define CSR_DOTPRODUCT_B0_ADDR (CSR_BASE + 0x24L)
#define CSR_DOTPRODUCT_B0_SIZE 1
#define CSR_DOTPRODUCT_B1_ADDR (CSR_BASE + 0x28L)
#define CSR_DOTPRODUCT_B1_SIZE 1
#define CSR_DOTPRODUCT_B2_ADDR (CSR_BASE + 0x2cL)
#define CSR_DOTPRODUCT_B2_SIZE 1
#define CSR_DOTPRODUCT_B3_ADDR (CSR_BASE + 0x30L)
#define CSR_DOTPRODUCT_B3_SIZE 1
#define CSR_DOTPRODUCT_B4_ADDR (CSR_BASE + 0x34L)
#define CSR_DOTPRODUCT_B4_SIZE 1
#define CSR_DOTPRODUCT_B5_ADDR (CSR_BASE + 0x38L)
#define CSR_DOTPRODUCT_B5_SIZE 1
#define CSR_DOTPRODUCT_B6_ADDR (CSR_BASE + 0x3cL)
#define CSR_DOTPRODUCT_B6_SIZE 1
#define CSR_DOTPRODUCT_B7_ADDR (CSR_BASE + 0x40L)
#define CSR_DOTPRODUCT_B7_SIZE 1

//------------------
#define CSR_DOTPRODUCT_B8_ADDR (CSR_BASE + 0x44L)
#define CSR_DOTPRODUCT_B8_SIZE 1
#define CSR_DOTPRODUCT_B9_ADDR (CSR_BASE + 0x48L)
#define CSR_DOTPRODUCT_B9_SIZE 1

#define CSR_DOTPRODUCT_C_ADDR (CSR_BASE + 0x4cL)
#define CSR_DOTPRODUCT_C_SIZE 1
//------------------


#define CSR_DOTPRODUCT_RESULT_ADDR (CSR_BASE + 0x50L)
#define CSR_DOTPRODUCT_RESULT_SIZE 2
#define CSR_DOTPRODUCT_BUSY_ADDR (CSR_BASE + 0x54L)
...
static inline uint32_t dotProduct_c_read(void) {
	return csr_read_simple((CSR_BASE + 0x4cL));
}
static inline void dotProduct_c_write(uint32_t v) {
